...
-- ----------------------------
INSERT INTO `personalinfo` VALUES ('1', 'Dean', 'Salangsang', 'Alan', 'Taytay, Rizal', '09129291122', 'email@ko.com', 'alan', 'alan', 'Teacher', '0', '::1', '2016-07-16 20:04:30');
INSERT INTO `personalinfo` VALUES ('2', 'Manalastas', 'Angeles', 'Edd Cristian', 'Angono, Rizal', '09173068260', 'edd.c.a.manalastas@gmail.com', 'edd', 'edd', 'Admin', '0', '::1', '2016-07-17 09:11:13');
INSERT INTO `personalinfo` VALUES ('3', 'Aviso', 'Fetalvero', 'Jefferson', 'Angono, Rizal', '09172222222', 'pep@pep.com', 'pep', 'pep', 'Student', '1', '::1', '2016-07-17 09:11:16');
INSERT INTO `personalinfo` VALUES ('4', 'Llagas', 'Gatela', 'Louie', 'Binangonan, Rizal', '1234', 'louie@lou.com', 'louie', 'louie', 'Teacher', '0', '::1', '2016-07-13 01:11:59');
INSERT INTO `personalinfo` VALUES ('5', 'dsadsadsa', 'asdsadsad', 'edd', 'dsadsadsadasd', 'asddsadsada', 'dasdsaddadas', 'asdasda', 'asdsad', 'Admin', '0', '', '0000-00-00 00:00:00');
...
INSERT INTO `qposttest` VALUES ('21', '32', '2', '7', 'DIFFICULT', 'typically considered to be a set of interrelated elements or components that collect (input), manipulate(processes), and dissiminate(output) and information and provide a feedback mechanism to meet an objective.', 'a.) data', 'b.) information', 'c.) IS', 'd.) none of the above', 'a.) data', 'b.) information', 'c.) IS', 'c.) IS', 'c', '3', '1', '2');
INSERT INTO `qposttest` VALUES ('22', '37', '2', '8', 'EASY', 'is a time boxed, iteractive approach to software development that builds software incrementally from the start of the project, instead of trying to deliver it all at once near the end.', 'a.) SCRUM', 'b.) AGILE', 'c.) WaterFall', 'd.) none of the above', 'a.) SCRUM', 'b.) AGILE', 'c.) WaterFall', 'c.) WaterFall', 'b', '1', '1', '2');
INSERT INTO `qposttest` VALUES ('23', '63', '2', '8', 'MEDIUM', 'this is known to be the device which can accept instructions from computer user', 'a.) input device', 'b.) output device', 'c.) both A & B', 'd.) none of the above', 'a.) input device', 'b.) output device', 'c.) both A & B', 'c.) both A & B', 'a', '1', '1', '2');
...
-- Records of qpretest
-- ----------------------------
INSERT INTO `qpretest` VALUES ('200', '1', '1', '2', 'EASY', 'the machine that changed the world', 'a.) Colossus', 'b.) SmartPhone', 'c.) Computer', 'd.) All the above', 'a.) Colossus', 'b.) SmartPhone', 'c.) Computer', 'c.) Computer', 'c', '2', '1', '1');
INSERT INTO `qpretest` VALUES ('201', '2', '1', '2', 'EASY', 'names whom contributed for the development of computers', 'a.) C.Babbage / T.Flowers / K. Warwick / Jeremy', 'b.) A. Turing / C.Babbage / Jeremy', 'c.) T.Flowers / A.Turing / K. Warwick / C. Babbage', 'd.) all of the above.', 'a.) C.Babbage / T.Flowers / K. Warwick / Jeremy', 'b.) A. Turing / C.Babbage / Jeremy', 'c.) T.Flowers / A.Turing / K. Warwick / C. Babbage', 'c.) T.Flowers / A.Turing / K. Warwick / C. Babbage', 'c', '1', '1', '1');
INSERT INTO `qpretest` VALUES ('202', '10', '1', '2', 'MEDIUM', 'a man made machine capable to automate human task', 'a.) desktop computer', 'b.) mainframe computer', 'c.) Colossus', 'd.) all of the above', 'a.) desktop computer', 'b.) mainframe computer', 'c.) Colossus', 'c.) Colossus', 'd', '1', '1', '1');
INSERT INTO `qpretest` VALUES ('203', '11', '1', '2', 'MEDIUM', 'refers to the physical tangible computer itself (an element of a complete computer system)', 'a.) people ware', 'b.) software', 'c.) hardware', 'd.) all of the above', 'a.) people ware', 'b.) software', 'c.) hardware', 'c.) hardware', 'c', '1', '1', '1');
INSERT INTO `qpretest` VALUES ('204', '18', '1', '2', 'MEDIUM', 'a collection of programs &/or modules that is combined all together to accomplish and/or automate human tasks', 'a.) system', 'b.) program', 'c.) machine instructions', 'd.) all of the above', 'a.) system', 'b.) program', 'c.) machine instructions', 'c.) machine instructions', 'a', '4', '1', '1');
INSERT INTO `qpretest` VALUES ('205', '19', '1', '2', 'MEDIUM', 'a collection of commands written by a programmer to accomplish specific task', 'a.) system', 'b.) program', 'c.) machine instructions', 'd.) all of the above', 'a.) system', 'b.) program', 'c.) machine instructions', 'c.) machine instructions', 'b', '1', '1', '1');
INSERT INTO `qpretest` VALUES ('206', '20', '1', '2', 'DIFFICULT', 'if i have 2 characters how many bytes do i have', 'a.) 8', 'b.) 16', 'c.) 2', 'd.) none of the above', 'a.) 8', 'b.) 16', 'c.) 2', 'c.) 2', 'c', '1', '1', '1');
INSERT INTO `qpretest` VALUES ('207', '21', '1', '2', 'DIFFICULT', 'keyboard is what type of device?', 'a.) input', 'b.) output', 'c.) input & output', 'd.) unknown', 'a.) input', 'b.) output', 'c.) input & output', 'c.) input & output', 'a', '1', '1', '1');
INSERT INTO `qpretest` VALUES ('208', '67', '1', '2', 'DIFFICULT', 'a software which contains programs that perform task needed for computer hardware to function efficiently. ', 'a.) system software / operating system', 'b.) microsoft windows', 'c.) IOS', 'd.) none / all of the above', 'a.) system software / operating system', 'b.) microsoft windows', 'c.) IOS', 'c.) IOS', 'a', '1', '1', '1');
INSERT INTO `qpretest` VALUES ('209', '68', '1', '2', 'EASY', 'a software that is used to govern the proper operation of a computer', 'a.) system software / operating system', 'b.) microsoft windows', 'c.) IOS', 'd.) none / all of the above', 'a.) system software / operating system', 'b.) microsoft windows', 'c.) IOS', 'c.) IOS', 'a', '3', '1', '1');
INSERT INTO `qpretest` VALUES ('221', '3', '1', '3', 'EASY', 'father of computer', 'a.) Charles Babbage', 'b.) Alan Turing', 'c.) Kevin Warwick', 'd.) none of the above', 'a.) Charles Babbage', 'b.) Alan Turing', 'c.) Kevin Warwick', 'c.) Kevin Warwick', 'a', '1', '1', '1');
INSERT INTO `qpretest` VALUES ('222', '12', '1', '3', 'MEDIUM', 'refers to the programs/system/machine instructions that is made by programmers.', 'a.) people ware', 'b.) software', 'c.) hardware', 'd.) all of the above', 'a.) people ware', 'b.) software', 'c.) hardware', 'c.) hardware', 'b', '1', '1', '1');
INSERT INTO `qpretest` VALUES ('223', '13', '1', '3', 'MEDIUM', 'refers to user/coders/programmers/computer operators (an element of a complete computer system)', 'a.) people ware', 'b.) software', 'c.) hardware', 'd.) all of the above', 'a.) people ware', 'b.) software', 'c.) hardware', 'c.) hardware', 'a', '1', '1', '1');
INSERT INTO `qpretest` VALUES ('224', '23', '1', '3', 'DIFFICULT', 'speaker is what type of device?', 'a.) input', 'b.) output', 'c.) input & output', 'd.) unknown', 'a.) input', 'b.) output', 'c.) input & output', 'c.) input & output', 'b', '2', '1', '1');
...
INSERT INTO `studyunits` VALUES ('14', '0', 'Introduction to Computer Programming', '1', '0');
INSERT INTO `studyunits` VALUES ('15', '14', 'Day 7 Basic Object Oriented Programming', '0', '14');
...
INSERT INTO `topic_config` VALUES ('2', '2', '2', '1', '1', '1', '0');
INSERT INTO `topic_config` VALUES ('6', '4', '1', '3', '3', '3', '0');
INSERT INTO `topic_config` VALUES ('7', '3', '1', '1', '1', '1', '1');
INSERT INTO `topic_config` VALUES ('8', '5', '1', '1', '1', '1', '0');
INSERT INTO `topic_config` VALUES ('9', '15', '1', '1', '1', '1', '0');
...
INSERT INTO `userlogs` VALUES ('136', '0', '2016-07-16', 'Good Login');
INSERT INTO `userlogs` VALUES ('137', '0', '2016-07-17', 'Good Login');
INSERT INTO `userlogs` VALUES ('138', '0', '2016-07-17', 'Good Login');
INSERT INTO `userlogs` VALUES ('139', '0', '2016-07-17', 'Good Login');
INSERT INTO `userlogs` VALUES ('140', '0', '2016-07-17', 'Good Login');
INSERT INTO `userlogs` VALUES ('141', '0', '2016-07-17', 'Good Login');
INSERT INTO `userlogs` VALUES ('142', '0', '2016-07-17', 'Good Login');
INSERT INTO `userlogs` VALUES ('143', '0', '2016-07-17', 'Good Login');
INSERT INTO `userlogs` VALUES ('144', '0', '2016-07-17', 'Good Login');
INSERT INTO `userlogs` VALUES ('145', '0', '2016-07-17', 'Good Login');
INSERT INTO `userlogs` VALUES ('146', '0', '2016-07-17', 'Good Login');
INSERT INTO `userlogs` VALUES ('147', '0', '2016-07-17', 'Good Login');
INSERT INTO `userlogs` VALUES ('148', '0', '2016-07-17', 'Good Login');
INSERT INTO `userlogs` VALUES ('149', '0', '2016-07-17', 'Good Login');
INSERT INTO `userlogs` VALUES ('150', '0', '2016-07-17', 'Good Login');
INSERT INTO `userlogs` VALUES ('151', '0', '2016-07-17', 'Good Login');
...
-- ----------------------------
-- Procedure structure for `generateQuestionsNonRandom`
-- ----------------------------
DROP PROCEDURE IF EXISTS `generateQuestionsNonRandom`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `generateQuestionsNonRandom`(IN `studid` INT, IN `topid` INT, IN `subid` VARCHAR(50), IN `_type` INT, IN `toteasy` INT, IN `totmed` INT, IN `totdiff` INT, IN `sessiontype` INT, IN `testtypeid` INT, IN `totitems` INT)
BEGIN
SELECT @testsessionid := IFNULL(MAX(testsessionid) + 1,1) FROM testhistory WHERE studentid = studid;
SELECT @totalcount :=  COUNT(id) FROM studentsession WHERE studentid = studid AND testsessionid = @testsessionid;
IF (@totalcount = totitems) THEN
