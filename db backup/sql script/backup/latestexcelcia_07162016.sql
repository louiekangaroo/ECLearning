...
insert  into `personalinfo`(`id`,`lname`,`mname`,`fname`,`address`,`contactno`,`emailadd`,`username`,`password`,`usertype`,`status`,`IPAddress`,`DateTimeActive`) values (1,'dean','salangsang','alan','taytay','123','email@ko.com','alan','alan','student','0','127.0.0.1','2016-07-13 01:09:42'),(2,'manalastas','edd','edd','angono','321','email@edd.com','edd','edd','admin','1','::1','2016-07-16 17:44:58'),(3,'pep','pep','pep','pep','pep','pep@pep.com','pep','pep','student','0','6.6.6.6','2016-07-13 01:07:36'),(4,'llagas','gatela','louie','binangonan','1234','louie@lou.com','louie','louie','student','0','::1','2016-07-13 01:11:59'),(6,'zzz','zzz','zzz','zzz','13','123','zzz','zzz','teacher','0','6.6.6.6','2016-07-13 01:47:00'),(7,'1','1','1','aaa','22','33','aa','aa','admin','0','::1','2016-07-13 01:12:03'),(8,'g','e','d','h','h','1','a','b','','0','','0000-00-00 00:00:00');
...
CREATE TABLE `topic_config` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=latin1 COMMENT='topic configuration to be defined by the teacher or admin';

/*Data for the table `topic_config` */

insert  into `topic_config`(`id`,`subjid`,`testtype`,`itemseasy`,`itemsmoderate`,`itemsdifficult`,`israndom`) values (1,2,1,3,4,3,1),(2,2,2,3,3,3,0),(6,4,1,3,3,3,0),(7,3,1,1,2,2,0);
